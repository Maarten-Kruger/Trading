...
input double InpMinDailyProfit = 10.0;    // Minimum period profit to count as profitable period
input int    InpPeriodDays     = 5;      // Number of days in each profit tracking period
uint   InpSlippage       = 5;      // Slippage in points
ulong  InpMagicNumber    = 1300033;// Magic number for HoverBreakout trades
