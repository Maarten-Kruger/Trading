...
PARAM_GRID = {
    'BACK_CANDLES': [18, DEFAULT_PARAMS['BACK_CANDLES'], 26],
    'CANDLE_SIZE_PIPS': [DEFAULT_PARAMS['CANDLE_SIZE_PIPS']],
    'TP_PIPS': [DEFAULT_PARAMS['TP_PIPS']],
    'SL_PIPS': [30, DEFAULT_PARAMS['SL_PIPS'], 70],
    'FUTURE_CANDLES': [15, DEFAULT_PARAMS['FUTURE_CANDLES'], 25],
