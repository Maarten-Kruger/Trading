...
input double InpPrK            = 0.585927;    // Payoff Ratio Steepness (k)
input double InpPrM            = 4.25;    // Payoff Ratio Midpoint (m)
input double InpMrK            = 0.005859;    // Monthly Return Steepness (k)
input double InpMrM            = 425;   // Monthly Return Midpoint (m)
input double InpNpK            = 0.004384;  // Negative Penalty Steepness (k)
input double InpNpM            = 500.0;  // Negative Penalty Midpoint (m)
input double InpTcK            = 0.079899;    // Trade Count Steepness (k)
input double InpTcM            = 42.5;   // Trade Count Midpoint (m)
input double InpSrK            = 0.878890;    // Sharpe Ratio Steepness (k)
input double InpSrM            = 2.5;    // Sharpe Ratio Midpoint (m)
input double InpRoRK           = 50;   // Risk of Ruin Steepness (k)
input double InpRoRM           = 0.043944;   // Risk of Ruin Midpoint (m)
